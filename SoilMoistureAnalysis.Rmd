...
summary(smois)
  ...
  #fixed effects
    ...
    #intercept = the average of our data for the Pasture 1 location
condition
plot(smois)

#Assumptions: creating a residual plot, a histogram of the residuals or a Q-Q plot 

smois2 <- lm(soil.moisture ~ factor(site) + (1|row) + (1|stake) + ff.thickness + bulk.density + soil.mass + soil.moisture + soil.moisture.capacity, data = soil)
summary(smois2)
```
