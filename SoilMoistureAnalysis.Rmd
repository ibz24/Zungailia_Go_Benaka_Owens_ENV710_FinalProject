...
#Best Model
smois2 <- lmer(soil.moisture ~ factor(site) + (1|row) + (1|stake) + ff.thickness + bulk.density + soil.mass + ph.h2o + n + nh4 + ca + mg + soil.moisture + soil.moisture.capacity, data = soil)
summary(smois2)
plot(smois2)

smois3 <- lmer(soil.moisture ~ factor(site) + (1|row) + (1|stake) + ff.thickness + soil.moisture.capacity, data = soil)
summary(smois3)
plot(smois3)

AIC(smois, smois2, smois3)
library(car)
vif(smois3)
